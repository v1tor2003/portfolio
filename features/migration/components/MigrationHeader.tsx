	...
	return (
		<div className="space-y-4">
			...
			<p className="text-zinc-400 max-w-3xl leading-relaxed font-mono text-sm sm:text-base">
				A technical log of modernizing from a legacy 2022 Create React App setup
				to Next.js 16 App Router, Turbopack, TypeScript 7, Biome, and an
				optimized 60fps HTML5 binary matrix canvas.
			</p>
		</div>
	);
}
