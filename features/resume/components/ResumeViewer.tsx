...
export function ResumeViewer({
				...
				<div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
					...
					<div className="flex flex-wrap items-center gap-3 shrink-0">
						<button
							...
							className="inline-flex items-center gap-2 px-5 py-2.5 bg-white hover:bg-zinc-200 text-black font-bold text-xs sm:text-sm rounded border border-white transition-all shadow-md cursor-pointer group"
						>
						...
						<a
							...
							className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-black hover:bg-zinc-900 text-zinc-300 hover:text-white text-xs sm:text-sm rounded border border-zinc-800 hover:border-zinc-700 transition-colors"
						>
	...
	return (
		...
		>
			<div className="flex items-center justify-between px-5 py-3.5 bg-black border-b border-zinc-800 text-xs text-white">
